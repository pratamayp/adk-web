...
import {
  ...
  ViewImageDialogData,
} from './view-image-dialog.component';
...
describe('ViewImageDialogComponent', () => {
  ...
  it('should display SVG data correctly', () => {
    ...
    const svgContainer = fixture.debugElement.query(
      By.css('.image-wrapper .svg-container')
    );
    expect(svgContainer).not.toBeNull();
    expect(svgContainer.nativeElement.innerHTML).toContain(
